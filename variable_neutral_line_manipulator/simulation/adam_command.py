...
class AdamViewSocket:
    ...
    def import_geometry(self, path, part_name=None, type_of_geometry="stp", encoding=None, location=None, orientation=None, relative_to=None):
        
        self.deal_with_command(construct_cmd("file geometry read", {
