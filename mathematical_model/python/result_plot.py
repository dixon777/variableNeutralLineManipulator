...
def defineEndPieceIteractiveFunc_plot():
    for index, (i,j,k,res) in enumerate(its.computeIterator(tensionLeft=1, tensionRight=0.5, curvatureRadius=2, curvatureAngle=math.pi/2,
