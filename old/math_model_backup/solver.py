...
class DiskModelState():
    ...
    def eval_proximal_disk_top_components(self, proximal_disk:DiskMathModel):
        ...
        # contact
        c = np.concatenate((-distal_to_proximal_frame(self.bottom_contact_reactionDF.force, self.bottom_joint_angle, top_orientationDF),
        -distal_to_proximal_frame(self.bottom_contact_reactionDF.total_moment, self.bottom_joint_angle, top_orientationDF)))
